...
dfMerge = dfMerge[['Week', 'State','Postal Code', 'GeoId', 'Longitude', 'Latitude', 'PRECTOT' ,'WS10M_MIN' ,'QV2M' ,'T2M_RANGE' ,'WS10M' ,'T2M' ,'WS50M_MIN' ,'T2M_MAX' ,'WS50M' ,'TS' ,'WS50M_RANGE' ,'WS50M_MAX' ,'WS10M_MAX' ,'WS10M_RANGE' ,'PS' ,'T2MDEW', 'T2M_MIN', 'T2MWET', 'Aland', 'Awater', 'Aland_SQMI', 'Awater_SQMI', 'LEVEL']]
